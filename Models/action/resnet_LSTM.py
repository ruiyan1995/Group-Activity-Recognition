...
__all__ = ['ResNet_LSTM', 'resnet18_LSTM', 'resnet34_LSTM', 'resnet50_LSTM', 'resnet101_LSTM',
           'resnet152_LSTM']
...
class ResNet_LSTM(nn.Module):
    ...
    def __init__(self, block, layers, model_confs, zero_init_residual=False):
        ...
        if self.do_LSTM:
            ...
            self.fc = nn.Linear(3000, model_confs.num_classes)
        else:
            self.fc = nn.Linear(512 * block.expansion, model_confs.num_classes)
        ###########################################################################################
...
def resnet18_LSTM(pretrained=False, **kwargs):
    ...
    """
    model = ResNet_LSTM(BasicBlock, [2, 2, 2, 2], **kwargs)
    if pretrained:
...
def resnet34_LSTM(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet_LSTM(BasicBlock, [3, 4, 6, 3], **kwargs)
    if pretrained:
...
def resnet50_LSTM(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet_LSTM(Bottleneck, [3, 4, 6, 3], **kwargs)
...
def resnet101_LSTM(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet_LSTM(Bottleneck, [3, 4, 23, 3], **kwargs)
    if pretrained:
...
def resnet152_LSTM(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet_LSTM(Bottleneck, [3, 8, 36, 3], **kwargs)
    if pretrained:
